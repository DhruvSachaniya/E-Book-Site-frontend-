                ...
                <div className="postbook-box">
                    <div style={{
                        ...
                        <form onSubmit={Postbookfunction}>
                            ...
                            <p style={{ marginTop: "1rem", marginLeft: "0.5rem" }}>If Catalogue Is Not exites? <Link to={'/postcatalogue'}><mark style={{ backgroundColor: "var(--color-silverockunivercity)", color: "var(--color-white)", borderRadius: "3px", padding: "0.3rem" }}>Catalogue</mark></Link></p>
                            <div>
                            ...
                            <p style={{ marginTop: "1rem", marginLeft: "0.5rem" }}>Return To Home Page? <Link to={'/home'}><mark style={{ backgroundColor: "var(--color-silverockunivercity)", color: "var(--color-white)", borderRadius: "3px", padding: "0.3rem" }}>Home Page</mark></Link></p>
